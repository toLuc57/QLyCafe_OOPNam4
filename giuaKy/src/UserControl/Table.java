...
public class Table extends javax.swing.JPanel {
    ...
    private void setImage(String src){
        ...
        Image newimg = i.getScaledInstance(150, 100, Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        txtSlot.setForeground(new java.awt.Color(255, 255, 255));
        ...
        txtIdTable.setBackground(new java.awt.Color(0, 51, 51));
