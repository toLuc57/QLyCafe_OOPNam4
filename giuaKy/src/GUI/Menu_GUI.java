...
public class Menu_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonCustom2 = new UserControl.JButtonCustom();
        ...
        jButtonCustom1.setForeground(new java.awt.Color(255, 255, 255));
        jButtonCustom1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_close_30px_1.png"))); // NOI18N
        jButtonCustom1.setText("Hủy");
        jButtonCustom1.setFont(new java.awt.Font("UTM Amherst", 1, 18)); // NOI18N
        jButtonCustom1.setStyle(UserControl.JButtonCustom.ButtonStyle.DESTRUCTIVE);
        rBottomRightBottom.add(jButtonCustom1, java.awt.BorderLayout.LINE_END);

        jButtonCustom2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/sucess.png"))); // NOI18N
        jButtonCustom2.setText("Xác nhận");
        jButtonCustom2.setFont(new java.awt.Font("UTM Americana EB", 0, 18)); // NOI18N
        rBottomRightBottom.add(jButtonCustom2, java.awt.BorderLayout.CENTER);
    ...
    private UserControl.JButtonCustom jButtonCustom2;
